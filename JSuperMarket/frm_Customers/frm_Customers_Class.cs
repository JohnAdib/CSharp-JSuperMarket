...
{
    class frm_Customers_Class
    {
        private string TableName = "dbo.tbl_SM_Customers";
        ...
        public void DBAdd()
        {
            string SQL = "Insert into " + this.TableName + " (CName, CAddress, CTel, CMobile, CDesc, Credit) "
        ...
        {
            string SQL = "Delete from " + this.TableName + " where CustomerID = {0}";
        ...
        {
            string SQL = "Update " + this.TableName + " Set CName = N'{0}', CAddress = N'{1}', CTel = N'{2}', CMobile = N'{3}', CDesc = N'{4}', Credit = {5} "
                                   + " where CustomerID = {6}";
        ...
        public void DBFind()
        {
            ...
            SelectedRecord = JSDA.DBSelectBySQL("Select * from " + this.TableName + " where CustomerID = " + this._CID);
