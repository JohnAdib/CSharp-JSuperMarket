...
{
    public partial class FrmProducts : frm_base_ShowData
    {
        bool _initializement = true;
        string _totalRowsCount = "";
        readonly frm_Products_Class _relatedClass = new frm_Products_Class();
...
//                 jscDataGrid1.Columns["PExpDate"].Visible = false;
        ...
        private void JscUpdate1Click(object sender, EventArgs e)
        {
            ...
            var editForm = new frm_Products_Edit(_relatedClass._PID, _relatedClass._PName, _relatedClass._PUID, _relatedClass._PCID
